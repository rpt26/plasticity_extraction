...
mdb.models[job_name].materials['Specimen'].Elastic(table=((sample_modulus, sample_poisson), ))
...
mdb.models[job_name].DisplacementBC(amplitude=UNSET, createStepName='Initial', 
    ...
    UNSET)
mdb.models[job_name].TabularAmplitude(data=((0.0, 0.0), (1.0, -1*max_displacement/1000)), name=
